...
const styles = StyleSheet.create({
  ...
  avatarRing: { width: 96, height: 96, borderRadius: 48, borderWidth: 3, borderColor: Colors.primary, backgroundColor: Colors.primaryAlpha10, overflow: 'hidden', marginBottom: 16, ...Shadows.glow },
  avatar: { width: '100%', height: '100%' },
  avatarFallback: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: Colors.primaryAlpha10 },
  avatarFallbackLetter: { color: Colors.primary, fontFamily: Typography.fontFamily.bold, fontSize: 32 },
  ...
  followBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.primary, borderRadius: BorderRadius.xl, paddingHorizontal: 28, paddingVertical: 11, marginTop: 16, ...Shadows.glow },
  followingBtn: { backgroundColor: 'transparent', borderWidth: 1, borderColor: Colors.border },
  followBtnText: { color: '#fff', fontSize: 14, fontFamily: Typography.fontFamily.bold },
