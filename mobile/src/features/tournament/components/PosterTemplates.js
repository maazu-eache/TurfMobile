...
const getBadgeStyle = (t, isFirst) => {
  if (t.type === "liquid_metal") {
    return {
      backgroundColor: isFirst ? t.badgeBg : "transparent",
      borderRadius: 12,
      borderWidth: isFirst ? 1 : 0,
      borderColor: isFirst ? t.borderColor : "transparent",
      padding: 12,
      marginBottom: 8,
      flexDirection: "row",
      alignItems: "center",
    ...
    return {
      ...
      borderRadius: 0,
      borderWidth: 1,
      borderColor: isFirst ? t.accentColor : "transparent",
    ...
    return {
      backgroundColor: isFirst ? "#333" : "#222",
      borderRadius: 6,
      borderWidth: isFirst ? 1 : 0,
      borderColor: "#555",
      padding: 12,
        ...
        <View style={{ padding: Spacing.lg, alignItems: "center" }}>
          ...
          >
            <View style={{ alignItems: "center", flex: 1 }}>
              <Image
                source={getSource(match?.teamA?.logo)}
                style={{
                  width: 60,
                  height: 60,
                  borderRadius: t.type === "cyberpunk" ? 0 : 30,
                  marginBottom: 8,
                  borderWidth: t.type === "cyberpunk" ? 2 : 2,
                  borderColor:
                    t.type === "cyberpunk" ? t.secTextColor : t.borderColor,
                }}
              />
              <Text
                style={{
            ...
            <View
              style={{ alignItems: "center", paddingHorizontal: Spacing.md }}
            >
              <Text
                style={{
                  color: t.accentColor,
            ...
            <View style={{ alignItems: "center", flex: 1 }}>
              <Image
                source={getSource(match?.teamB?.logo)}
                style={{
                  width: 60,
                  height: 60,
                  borderRadius: t.type === "cyberpunk" ? 0 : 30,
          ...
          >
            ...
            >
              Date:{" "}
              {new Date(
                match?.scheduledAt || match?.createdAt || Date.now(),
...
export const PointsTablePoster = ({
  pointsTable,
  tournamentName,
  groupName,
  theme,
      ...
      <View style={{ width: "100%", backgroundColor: t.overlayBg }}>
        ...
        >
          ...
          <View
            style={{
              flexDirection: "row",
              borderBottomWidth: t.type === "cyberpunk" ? 2 : 1,
              borderBottomColor:
                t.type === "cyberpunk" ? t.accentColor : t.borderColor,
              paddingVertical: 8,
            }}
          >
            <Text
          ...
          {(pointsTable || []).slice(0, 10).map((row, index) => (
            <View
              ...
              style={{
                flexDirection: "row",
                borderBottomWidth: t.type === "cyberpunk" ? 1 : 1,
                borderBottomColor:
                  t.type === "cyberpunk" ? t.secTextColor : t.borderColor,
                paddingVertical: 10,
                alignItems: "center",
            ...
            >
              ...
              >
                ...
                <Image
                  source={getSource(row.team?.logo)}
                  style={{
                    width: 20,
                    height: 20,
                    borderRadius: t.type === "cyberpunk" ? 0 : 10,
                    marginRight: 6,
                  }}
                />
                <Text
              ...
              >
                {row.netRunRate
                  ? parseFloat(row.netRunRate).toFixed(3)
                  : "0.000"}
              </Text>
            </View>
          ))}
...
export const LeaderboardPoster = ({
  type,
  data,
  tournamentName,
  theme,
  ...
  const getTitle = () => {
    switch (type) {
      ...
      case "fours":
        return "Most Fours";
      case "strikeRate":
        return "Highest Strike Rate";
      case "economy":
        return "Best Economy";
      case "catches":
        return "Best Fielders";
      case "mvp":
        return "MVP Rankings";
      default:
        return "Leaderboard";
...
export const FullSchedulePoster = ({
  matches,
  tournamentName,
  theme,
  tournamentBanner,
            ...
            >
              ...
              <View style={{ padding: Spacing.md }}>
                ...
                >
                  ...
                  >
                    {moment(m.scheduledAt || m.createdAt).format(
                      "DD MMM, hh:mm A",
                    )}
                  </Text>
                </View>
...
export const MatchSummaryPoster = ({ liveState, theme }) => {
  ...
  if (matchStatus === "completed" && teamAScore && teamBScore) {
    ...
    mainScore = `${teamAScore.runs}/${teamAScore.wickets} - ${teamBScore.runs}/${teamBScore.wickets}`;
  } else if (teamAScore && (teamAScore.runs > 0 || teamAScore.overs > 0 || teamAScore.overs !== "0.0")) {
    mainScore = `${teamAScore.runs}/${teamAScore.wickets} (${teamAScore.overs})`;
  }
